package io.github.marciliodevjava.security.jwt;
...
import io.github.marciliodevjava.ConsultaH2;
...
public class JwtService {
	...
	public static void main(String[] args) {
		ConfigurableApplicationContext contexto = SpringApplication.run(ConsultaH2.class);
		JwtService service = contexto.getBean(JwtService.class);
		Usuario usuario = Usuario.builder().login("fulano").build();
		String token = service.gerarToken(usuario);
		String tokenUsers = service.gerarToken(usuario);
		System.out.println(tokenUsers.toString());
